...
class DsDateRangeFormField extends ShadDateRangePickerFormField {
  DsDateRangeFormField({
    ...
    /// {@macro DSDatePicker.placeholder}
    super.placeholder,

    /// {@macro DSDatePicker.closeOnSelection}
    super.closeOnSelection,

    /// {@macro DSDatePicker.formatDateRange}
    String Function(DSDateTimeRange)? formatDateRange,

    /// {@macro DSDatePicker.allowDeselection}
    super.allowDeselection,

    /// {@macro DSDatePicker.header}
    super.header,

    /// {@macro DSDatePicker.footer}
    super.footer,
    ...
    /// {@macro DSCalendar.insideRangeDayButtonTextStyle}
