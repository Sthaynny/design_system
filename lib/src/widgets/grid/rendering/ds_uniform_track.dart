...
class DSUniformTrackParentData extends ContainerBoxParentData<RenderBox> {}

class DSRenderUniformTrack extends RenderBox
    with
        ContainerRenderObjectMixin<RenderBox, DSUniformTrackParentData>,
        RenderBoxContainerDefaultsMixin<RenderBox, DSUniformTrackParentData> {
  DSRenderUniformTrack({
  ...
  void setupParentData(RenderBox child) {
    if (child.parentData is! DSUniformTrackParentData) {
      child.parentData = DSUniformTrackParentData();
    }
  }

  DSUniformTrackParentData _getParentData(RenderBox child) {
    return child.parentData as DSUniformTrackParentData;
  }
