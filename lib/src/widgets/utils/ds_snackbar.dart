...
class DSSnackBar extends SnackBar {
  ...
  factory DSSnackBar.error(String text, {SnackBarAction? action}) =>
      DSSnackBar._(
        text: text,
  ...
  factory DSSnackBar.success(String text, {SnackBarAction? action}) =>
      DSSnackBar._(
        text: text,
  ...
  factory DSSnackBar.warning(String text, {SnackBarAction? action}) =>
      DSSnackBar._(
        text: text,
  ...
  factory DSSnackBar.info(String text, {SnackBarAction? action}) =>
